# HTTP Trace and Access Log File Rotation Support for ballerina/http
...
public enum HttpLogRotationPolicy {
...
public type HttpLogRotationConfig record {|
    # Rotation policy to apply.
    # Default: BOTH
    HttpLogRotationPolicy policy = BOTH;
...
public type TraceLogAdvancedConfiguration record {|
    ...
    HttpLogRotationConfig rotation?;
|};
```
...
**Approach** — Expose Existing File Size–Based Rotation Configurations in Java Default File Handler
